...
b.numero,
fb.estado,
fb.id_funcion_butaca,
f.precio

FROM butaca b

INNER JOIN funcion_butaca fb
ON b.id_butaca = fb.id_butaca
...
<body>
    <section id="sala-cine" class="sala-cine">
        ...
        <ul class="leyenda">
            <li>
                <div class="asiento"></div> Disponible
            </li>
            <li>
                <div class="asiento seleccionado"></div> Seleccionado
            </li>
            <li>
                <div class="asiento ocupado"></div> Ocupado
            </li>
        </ul>
        <p class="resumen-texto">
            Asientos:
            <span id="lista-asientos">-</span>
        </p>
